	...
	.clkr = {
		...
		.vdd_data = {
			...
			.rate_max = (unsigned long[VDD_NUM]) {
				...
				[VDD_LOWER] = 800000000,  // 615MHz → 800MHz
				[VDD_LOW] = 1200000000,   // 1.066GHz → 1.2GHz
				[VDD_LOW_L1] = 1800000000, // 1.5GHz → 1.8GHz (安全圏)
				[VDD_NOMINAL] = 2000000000, // 1.75GHz → 2.0GHz
				[VDD_HIGH] = 2300000000},   // 2.0GHz → 2.5GHz
		},
	},
};
...
static struct clk_alpha_pll gcc_gpll2 = {
	...
	.clkr = {
		...
		.vdd_data = {
			...
			.num_rate_max = VDD_NUM,
			.rate_max = (unsigned long[VDD_NUM]) {
				[VDD_LOWER_D1] = 700000000,  // 615MHz → 700MHz (少し余裕を持たせる)
				[VDD_LOW] = 1100000000,  
				[VDD_LOW_L1] = 1700000000,  // 1.6GHz → 1.7GHz
				[VDD_NOMINAL] = 2000000000}, // 2GHz 以上は通常電圧
		},
	},
};
